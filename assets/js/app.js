...
function isAvailable(productId, start, end) {
  ...
  // 1️⃣ BLOKADA: jeśli jakikolwiek dzień w zakresie to weekday (np. Sunday)
  ...
  // 2️⃣ BLOKADA: jeśli start day = weekday (np. Sunday)
  for (const b of adminBlocks) {
  ...
  // 3️⃣ BLOKADA: jeśli end day = weekday (np. Sunday)
  for (const b of adminBlocks) {
